        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            @else
              ...
              <li class="nav-item">
                <a class="nav-link"
                  href="{{ route('contact-shares.index') }}">Shared Contacts</a>
              </li>
              <li class="nav-item">
                <a class="nav-link"
                  href="{{ route('contact-share.create') }}">Share Contact</a>
              </li>
              <li class="nav-item">
    ...
    <main class="py-4">
      @if (session()->has('alert'))
        <div class="container">
          ...
          <div
            class="alert alert-{{ session()->get('alert')['type'] }} d-flex align-items-center"
            role="alert">

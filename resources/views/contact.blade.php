    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('contacts.store') }}"> <!--Con esto nos evitamos meter las rutas a mano. Lo enlazamos con un nombre de routes de web.php que luego se resuelve como un URI-->
              @csrf
